...
const remotesMap = {
'remoteApp':{url:'http://localhost:5002/remoteEntry.js?version=^1.0.0',format:'esm',from:'vite'}
};
...
const __federation_var_remoteAppButton = await __federation_method_getRemote("remoteApp" , "./Button");
 let Button = __federation_method_unwrapDefault(__federation_var_remoteAppButton); 
function App() {
  return /* @__PURE__ */ jsxs("div", { className: "App", children: [
    /* @__PURE__ */ jsx("div", { children: /* @__PURE__ */ jsx("a", { href: "https://reactjs.org", target: "_blank", children: /* @__PURE__ */ jsx("img", { src: reactLogo, className: "logo react", alt: "React logo" }) }) }),
